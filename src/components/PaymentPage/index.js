        ...
        <div>
            ...
            <div className='pay-container'>
                <div className='payment-main-con'>
                    ...
                    <p className='pay-para-add' style={{'fontWeight': 'bold', 'fontSize': '14px'}}>Visa ***1111 (Amazon Pay)</p>
                    <hr/>
                    ...
                    <div className="d-flex flex-row">
                        ...
                        <div style={{'marginTop':'38px', "marginLeft":'50px'}}>
                            <p><BsCurrencyRupee/>1,000.00</p>
                            <p><BsCurrencyRupee/>0.00</p>
                            <p><BsCurrencyRupee/>1,000.00</p>
                            <p><BsCurrencyRupee/>0.00</p>
                            <p className='text-danger' style={{'fontWeight': 'bold', 'fontSize': '15px'}}><BsCurrencyRupee/>1,000.00</p>
                        </div>
                    </div>
